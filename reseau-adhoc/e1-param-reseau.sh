...
echo "\033[38;5;45m $ ip -br address\033[0m"
ip -br address
echo -e "\n+--------------------------------------------------+\n"
...
echo "\033[38;5;45m $ iwconfig $IFACE; iwlist $IFACE channel | grep Current Frequency \033[0m"
iwconfig "$IFACE"
...
echo "\033[38;5;45m $ sudo iwlist $IFACE scan | grep -E Cell|Frequency|Quality|ESSID \033[0m"
sudo iwlist "$IFACE" scan | grep -E "Cell|Frequency|Quality|ESSID" | sed 's/^[ \t]*//'
echo -e "\n+--------------------------------------------------+\n"

# Statistiques TX/RX
echo "Statistiques de l'interface :"
echo "\033[38;5;45m $ cat /proc/net/dev \033[0m"
cat /proc/net/dev 
echo -e "\n+--------------------------------------------------+\n"

# Taux de perte de paquets
echo "Taux de perte de paquets :"
echo "\033[38;5;45m $ ping -c 10 google.com | grep -oP '\d+(?=% packet loss)' \033[0m"
